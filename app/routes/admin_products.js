        ...
        Product.findOne({slug: slug}, function (err, product) {
            if (product) {
                ...
                product.save(function (err) {
                    ...
                    fs.ensureDir('public/product_images/' + product._id + '/gallery', function (err) {
                        return console.log(err);
                    });

                    fs.ensureDir('public/product_images/' + product._id + '/gallery/thumbs', function (err) {
                        return console.log(err);
                    });
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        res.render('admin/edit_product', {
                            ...
                            desc: p.desc,
                            checkpoints: checkpoints,
                            checkpoint: p.checkpoint.replace(/\s+/g, '-').toLowerCase(),
                            seller: p.seller,
                            quantity: p.quantity,                           
